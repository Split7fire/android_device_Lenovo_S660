...
DEVICE_FOLDER := device/Lenovo/S660

USE_CAMERA_STUB := true

# inherit from the proprietary version
-include vendor/Lenovo/S660/BoardConfigVendor.mk

TARGET_NO_BOOTLOADER := true
TARGET_BOOTLOADER_BOARD_NAME := S660
TARGET_OTA_ASSERT_DEVICE := S660
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 6209142784
